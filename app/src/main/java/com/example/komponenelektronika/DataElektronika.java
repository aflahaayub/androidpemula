...
public class DataElektronika {
    private static String [] namaKomponen = {
            "Dioda",
            "Resistor",
            "LCD",
            "Kapasitor",
    ...
    private static String[] penjelasanKomponen = {
    ...
    private static int[] gambarKomponen = {
            R.drawable.dioda,
            R.drawable.rresistor,
            R.drawable.llcd,
            R.drawable.kkapasitor,
            R.drawable.ic,
            R.drawable.iinduktor,
            R.drawable.buzzer,
            R.drawable.ppowersupply,
            R.drawable.sswitch,
            R.drawable.ttrafo,
            R.drawable.ssolenoida
    ...
    static ArrayList<Komponen> getListData(){
        ...
        for (int position = 0; position< namaKomponen.length; position++){
            Komponen komponen = new Komponen();
            komponen.setName(namaKomponen[position]);
            komponen.setDetail(penjelasanKomponen[position]);
            komponen.setPhoto(gambarKomponen[position]);
            list.add(komponen);
        }
        return list;
    }
